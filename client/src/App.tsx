      ...
      <main>
          ...
          >
            ...
            <div className="portraitCard">
              <div className="portraitImage">
                <img
                  src={images.hero}
                  alt="Julie Sutherland marketing strategist"
                  loading="eager"
                />
              </div>
        ...
        <section className="aboutSection sectionContainer" id="about">
          ...
          >
            <div className="videoPortrait">
              <img
                src={images.about}
                alt="Julie Sutherland working on marketing strategy"
                loading="lazy"
              />
              ...
              <button
                ...
                type="button"
                aria-label="Play Julie introduction"
              >
            ...
            {t.services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <a href="#packages" aria-label={`${service.title} package`}>
                    <ArrowRight size={18} />
                  </a>
                </motion.article>
              );
        ...
        <section className="packagesSection sectionContainer" id="packages">
          ...
          <div className="packageGrid">
            {t.packages.map((pack, index) => (
              <motion.article
                className={`packageCard ${index === 2 ? 'featuredPackage' : ''}`}
                key={pack.name}
                variants={fadeUp}
                initial="hidden"
                whileInView="show"
              ...
              >
                {index === 2 && (
                  <span className="popularBadge">
                    {language === 'en' ? 'Best Value' : 'Melhor Valor'}
                  </span>
                )}
        ...
        <section className="responsivePreview sectionContainer" aria-label="Mobile preview">
          <div className="previewCopy">
            ...
            <h2>
              {language === 'en'
                ? 'Built mobile-first, refined for every screen.'
                : 'Criado mobile-first, refinado para todas as telas.'}
            </h2>
            ...
            <p>
              {language === 'en'
                ...
                : `O layout mantém a marca da Julie premium em celulares, tablets e desktops, com seções rápidas, ações claras e uma experiência bilíngue elegante.`}
            </p>
          </div>
      ...
      <footer className="siteFooter sectionContainer" id="contact">
        <div className="footerBrand">
          ...
          <div className="footerSocials">
            ...
            <a href={`mailto:${contact.email}`} aria-label="Email Julie">
              <Mail size={20} />
            </a>
          </div>
        </div>
